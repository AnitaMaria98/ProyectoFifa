								...
								<table class="alt">
									...
									<tbody>
										...
										for (int i = 0; i < ligas.size(); i++) {
											int cod = ligas.get(i).getCod_liga();
											String nombre = ligas.get(i).getNombre();
											String pais = ligas.get(i).getPais();
											ArrayList<Equipo> equipos = controlador.dameEquiposLiga(ligas.get(i).getCod_liga());
										%>
											<tr>
											<td width='60' rowspan="2"><img src="images/ligas/<% out.print(cod); %>.png" title="<%out.print(ligas.get(i).getNombre());%>" class="imagenEscudo"/></td>
